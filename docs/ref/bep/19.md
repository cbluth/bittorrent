...
**For example (on multiple lines for readability):**: d 8:announce27:http://tracker.com/announce 8:url-list26:http://mirror.com/file.exe 4:info...
...
**For example:**: ... 8:url-list22:http://mirror.com/pub/ 4:infod5:filesld6:lengthi949e4:pathl10:Readme.txte e4:name7:michael A client would use all that to build a url: http://mirror.com/pub/michael/Readme.txt
...
<!-- Source: https://bittorrent.org/beps/bep_0019.html -->

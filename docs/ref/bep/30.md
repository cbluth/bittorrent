...
single Merkle hash [1]. A Merkle hash can be used to verify the integrity
...
`info` part instead of a `pieces` key, see BEP 3 [2].
...
support the Extension protocol (BEP 10) [3]. In particular, it must add
...
[2] BEP_0003. The BitTorrent Protocol Specification, Cohen ([http://www.bittorrent.org/beps/bep_0003.html](http://www.bittorrent.org/beps/bep_0003.html))
...
[4] BEP_0017. HTTP Seeding, Hoffman ([http://www.bittorrent.org/beps/bep_0017.html](http://www.bittorrent.org/beps/bep_0017.html))

[5] BEP_0019. WebSeed - HTTP/FTP Seeding (GetRight style), Burford ([http://www.bittorrent.org/beps/bep_0019.html](http://www.bittorrent.org/beps/bep_0019.html))
...
<!-- Source: https://bittorrent.org/beps/bep_0030.html -->

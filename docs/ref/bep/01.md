# BEP 1 — The BitTorrent Enhancement Proposal Process
...
as an issue in the bittorrent.org github repository [1].
...
This document was derived heavily from PEP-0001 [2]. In many places
...
[1] *(1, 2)* bittorrent.org github repository ([https://github.com/bittorrent/bittorrent.org](https://github.com/bittorrent/bittorrent.org))

[2] PEP-001: PEP Purposes and Guidelines, Warsaw, Hylton, Goodger. ([http://www.python.org/dev/peps/pep-0001](http://www.python.org/dev/peps/pep-0001))
...
<!-- Source: https://bittorrent.org/beps/bep_0001.html -->

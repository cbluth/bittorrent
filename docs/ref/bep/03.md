...
possibly the last one which may be truncated. `piece length` is almost always a power of two, most commonly 2 18 =
...
the peer list, see [BEP 23](bep_0023.html).
...
<!-- Source: https://bittorrent.org/beps/bep_0003.html -->

...
[1] *Real-World Sybil Attacks in BitTorrent Mainline DHT*, Liang Wang and Jussi Kangasharju ([https://www.cl.cam.ac.uk/~lw525/publications/security.pdf](https://www.cl.cam.ac.uk/~lw525/publications/security.pdf))

[2] Libtorrent DHT extensions, Forward Compatibility ([http://libtorrent.org/dht_extensions.html#forward-compatibility](http://libtorrent.org/dht_extensions.html#forward-compatibility))
...
<!-- Source: https://bittorrent.org/beps/bep_0051.html -->

...
peer becomes a tracker. The protocol is based on Kademila [1] and is
...
BitTorrent infohashes [2]. A "distance metric" is used to
...
2[160]. The routing table is subdivided into "buckets" that
each cover a portion of the space. An empty table has one bucket with
an ID space range of min=0, max=2[160]. When a node with ID
...
new buckets covering the ranges 0..2[159] and
2[159]..2[160].
...
in BEP 20 [3] followed by a two character version identifier. Not all
...
[1] Peter Maymounkov, David Mazieres, "Kademlia: A Peer-to-peer Information System Based on the XOR Metric", *IPTPS 2002*. [http://www.cs.rice.edu/Conferences/IPTPS02/109.pdf](http://www.cs.rice.edu/Conferences/IPTPS02/109.pdf)

[2] Use SHA1 and plenty of entropy to ensure a unique ID.

[3] BEP_0020. Peer ID Conventions. ([http://www.bittorrent.org/beps/bep_0020.html](http://www.bittorrent.org/beps/bep_0020.html))
...
<!-- Source: https://bittorrent.org/beps/bep_0005.html -->

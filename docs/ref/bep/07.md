...
**Created:** 31-Jan-2008
**Post-History:** 07-Sep-2017 (the8472.bep@infinite-source.de), multi-homed trackers , 12-mar-2020 (arvid@libtorrent.org) discourage IP announce params and clarify announcing multiple listen interfaces
...
are either on an IPv4 network running [Teredo](https://www.microsoft.com/technet/network/ipv6/teredo.mspx) or peers are on
an IPv6 network with an IPv4 tunnel interface.

The key words "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD",
"SHOULD NOT", "RECOMMENDED", "MAY", and "OPTIONAL" in this document are to
be interpreted as described in IETF [RFC 2119](http://tools.ietf.org/html/rfc2119).
...
described in [BEP-23](http://www.bittorrent.org/beps/bep_0023.html), no change is necessary. Since the
...
<!-- Source: https://bittorrent.org/beps/bep_0007.html -->

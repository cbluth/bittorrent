...
[1] to allow operation over IPv6.
...
> octets [3]. In particular, such a packet will cross a Teredo
> tunnel with no fragmentation.
>
>
> In principle, IPv4 nodes might be unable to reassemble packets
> larger than 576 octets [4]; in practice, however, due to the
...
> protocol [2], which advertises a peer's addresses across
...
[1] BEP_0005. DHT Protocol. ([http://www.bittorrent.org/beps/bep_0005.html](http://www.bittorrent.org/beps/bep_0005.html))
...
<!-- Source: https://bittorrent.org/beps/bep_0032.html -->

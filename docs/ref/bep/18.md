# BEP 18 — Search Engine Specificiation
...
description document](http://www.opensearch.org/Specifications/OpenSearch), and consists of the following elements.
...
<!-- Source: https://bittorrent.org/beps/bep_0018.html -->

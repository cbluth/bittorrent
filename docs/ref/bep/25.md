# BEP 25 — An Alternate BitTorrent Cache Discovery Protocol
...
[3] though further from the intended usage of the Domain Name
...
However, section 4.3.3 in [5] specifies that wildcards only
appear as the first label in a domain name. This restriction was
lifted in [7], but not with semantics applicable to our use
...
implementing BEP 24 [4] or from peers using the *yourip*
extension defined for the *Extension Protocol* proposed in [2].
...
[2] BEP_0010. Extension Protocol. Norberg, Strigeus, Hazel [http://www.bittorrent.org/beps/bep_0010.html](http://www.bittorrent.org/beps/bep_0010.html)

[3] BEP_0022. BitTorrent Cache Discovery Protocol. Harrison, Shalunov, Hazel. [http://www.bittorrent.org/beps/bep_0010.html](http://www.bittorrent.org/beps/bep_0010.html)

[4] BEP_0024. Tracker Returns External IP. Harrison [http://www.bittorrent.org/beps/bep_0024.html](http://www.bittorrent.org/beps/bep_0024.html)

[5] *(1, 2)* RFC-1034. DOMAIN NAMES - CONCEPTS AND FACILITIES. Mockapetris, November 1987. [http://tools.ietf.org/html/rfc1034](http://tools.ietf.org/html/rfc1034)

[6] RFC-2782. A DNS RR for specifying the location of services (DNS SRV). Gulbrandsen, Vixie, Esibov. February 2000. [http://tools.ietf.org/html/rfc2782](http://tools.ietf.org/html/rfc2782)

[7] RFC-4592. The Role of Wildcards in the Domain Name System. Lewis [http://www.faqs.org/rfcs/rfc4592.html](http://www.faqs.org/rfcs/rfc4592.html)
...
<!-- Source: https://bittorrent.org/beps/bep_0025.html -->

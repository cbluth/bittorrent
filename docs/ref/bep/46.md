...
DHT [1], rather than an HTTP server. The publisher has control over when
the torrent is updated, and which content it contains, via mutable DHT items. It
is similar to BEP 39 [2], with the difference being that it uses the DHT
...
BEP 39 [2] allows to automatically update torrents based on HTTP URLs.
With DHT storing capabilities [1], we can implement similar functionality
...
[https://github.com/lmatteis/dmt](https://github.com/lmatteis/dmt)

## References

[1] *(1, 2, 3, 4)* BEP_0044. Storing arbitrary data in the DHT. ([http://www.bittorrent.org/beps/bep_0044.html](http://www.bittorrent.org/beps/bep_0044.html))

[2] *(1, 2)* BEP_0039. Updating Torrents Via Feed URL. ([http://www.bittorrent.org/beps/bep_0039.html](http://www.bittorrent.org/beps/bep_0039.html))
...
<!-- Source: https://bittorrent.org/beps/bep_0046.html -->

...
7. It is RECOMMENDED that the filename of a feed item is the same as name field of its contents. Publishers MAY shorten the names to reduce overhead on very large archives containing many small torrents. Additionally publishers SHOULD avoid using duplicate names for files with different content. Subscribers MUST NOT rely on that. Similarly the `.torrent` extension should be used for all feed items, assuming that they are torrents.
...
[1] BEP_0035. Torrent Signing ([http://www.bittorrent.org/beps/bep_0035.html](http://www.bittorrent.org/beps/bep_0035.html))

[2] BEP_0036. Torrent RSS feeds ([http://www.bittorrent.org/beps/bep_0036.html](http://www.bittorrent.org/beps/bep_0036.html))

[3] BEP_0039. Updating Torrents Via Feed URL. ([http://www.bittorrent.org/beps/bep_0039.html](http://www.bittorrent.org/beps/bep_0039.html))

[4] BEP_0046. Updating Torrents Via DHT Mutable Items. ([http://www.bittorrent.org/beps/bep_0046.html](http://www.bittorrent.org/beps/bep_0046.html))

[5] *(1, 2)* BEP_0047. Padding files and extended file attributes. ([http://www.bittorrent.org/beps/bep_0047.html](http://www.bittorrent.org/beps/bep_0047.html))
...
<!-- Source: https://bittorrent.org/beps/bep_0049.html -->

...
Reverse DNS lookups are described in RFC 1034 [4].
The SRV resource record type is described in RFC 2782 [6].
...
4.3.2 in [4] then all subdomains of pacbell.net that do not
...
Section 4.3.3 in [4] specifies that wildcards only appear as
the first label in a domain name. This restriction was lifted in
[7], but not with semantics applicable to our use case. An
...
[3] or from peers implementing the *yourip* extension defined
for the *Extension Protocol* proposed in [2].
...
[3] BEP_0024. Tracker Returns External IP. Harrison. [http://www.bittorrent.org/beps/bep_0024.html](http://www.bittorrent.org/beps/bep_0024.html)

[4] *(1, 2, 3)* RFC-1034. DOMAIN NAMES - CONCEPTS AND FACILITIES. Mockapetris, November 1987. [http://tools.ietf.org/html/rfc1034](http://tools.ietf.org/html/rfc1034)

[5] RFC-2119. [http://www.ietf.org/rfc/rfc2119.txt](http://www.ietf.org/rfc/rfc2119.txt)
...
<!-- Source: https://bittorrent.org/beps/bep_0022.html -->
